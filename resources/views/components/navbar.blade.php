{{-- <nav class="flex mx-auto justify-between max-w-6xl p-6 items-center sm:justify-between sm:max-w-sm  md:max-w-xl">
    ...
    <!-- menu -->       
    <ul class="flex flex-row space-x-6 sm:hidden md:hidden">
      <li>
      ...
      <li>
        <a href="{{ url('#tentang') }}" class="text-sm font-medium text-prim hover:bg-prim/10 p-2 rounded-lg">Tentang</a>
      </li>
    </ul>

    <!-- Hamburger Button -->
    <button id="hamburger" class="sm:block md:block hidden text-prim">
    ...
    <!-- mobile -->
    <div id="mobile-menu" class="fixed inset-0 p-5 bg bg-white bg-opacity-50 backdrop-blur-sm shadow-lg lg:hidden md:hidden hidden z-50">
      <div class="p-2">
        <button id="close-menu-a" class="text-prim absolute right-8 text-3xl">
          &times;
        </button>
        <ul class="mt-10 p-4 space-y-2 rounded-xl bg-white">
          <li>
          ...
          <li>
            <a href="{{ url('#tentang') }}" class="block text-base font-medium text-prim hover:bg-prim/10 p-2 rounded-md">Tentang</a>
          </li>
        </ul>
      </div>          
    </div>
    ...
    <div id="tab-menu" class="fixed inset-0 bg-white p-5 shadow-lg lg:hidden hidden sm:hidden z-50">
      <button id="close-menu-b" class="text-prim absolute top-5 right-5 text-2xl">
        &times;
      </button>
      <ul class="mt-10 space-y-4">
        ...
        <li>
          <a href="#about" class="block text-base font-medium text-prim hover:bg-slate-200 p-2 rounded-md">Tentang</a>
        </li>
      </ul>
    </div>
