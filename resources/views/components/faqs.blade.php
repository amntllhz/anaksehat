<section class="max-w-6xl mx-auto p-10 sm:w-full sm:p-4">
    <div class="p-10 sm:p-4">
      ...
      <div class="mt-6">      
        <div id="accordion-flush" data-accordion="collapse" data-active-classes="text-sm bg-white dark:bg-gray-900 text-[#35C6A8] dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
          ...
          <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
              <p class="mb-2 text-justify text-gray-500 text-sm dark:text-gray-400">anaksehat merupakan platform yang menyediakan informasi gizi balita, pola makan sehat, serta cara mengatasi tantangan asupan untuk balita. Platform ini juga dilengkapi sistem Cek status gizi otomatis.</p>            
            </div>
          </div>
          ...
          <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
              <p class="mb-2 text-justify text-gray-500 text-sm dark:text-gray-400">Tujuan utama website Anaksehat adalah memberikan informasi akurat dan terpercaya seputar gizi balita, serta memberikan edukasi mengenai makanan yang sehat dan seimbang untuk anak-anak di usia dini. Kami juga berfokus pada penyuluhan tentang dampak kekurangan gizi dan cara-cara mencegahnya.</p>            
            </div>
          </div>
          ...
          <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
            <div class="py-5 dark:border-gray-700">
              <p class="mb-2 text-justify text-gray-500 text-sm dark:text-gray-400">Anda dapat mengakses berbagai artikel, panduan, dan tips terkait gizi balita berdasarkan usia dan kebutuhan spesifik. Kami menyediakan informasi yang mudah dipahami mengenai jenis makanan yang tepat, jadwal makan yang ideal, serta tanda-tanda apabila anak mengalami kekurangan gizi. Anda juga dapat mencari informasi berdasarkan kategori tertentu, seperti gizi seimbang, menu makan sehat, atau cara meningkatkan nafsu makan balita.</p>              
            </div>
          </div>
        </div>
      </div>
