...
<body class="font-in font-feature-settings-cv11">
    ...
    <section class="max-w-6xl p-10 mx-auto sm:w-full sm:p-6">
        <div class="flex font-semibold text-prim">                    
            {{ Breadcrumbs::render('kontributor') }}    
        </div>
    </section>
        ...
        <div class="flex flex-col w-full mb-10 sm:px-2">
            ...
            <div class="space-y-2 mb-4">                
                <p class="text-gray-500 text-sm text-justify leading-relaxed">
                    Halaman ini menampilkan para kontributor yang berperan penting dalam mewujudkan misi AnakSehat sebagai platform edukasi gizi balita terpercaya. Mereka adalah individu dengan keahlian di bidang gizi, kesehatan, dan tumbuh kembang anak yang secara konsisten berbagi wawasan, penelitian, dan pengalaman profesional mereka. Berkat kontribusi mereka, AnakSehat mampu menyajikan informasi yang akurat, kredibel, dan relevan, sehingga mendukung para orang tua dalam memastikan tumbuh kembang anak yang optimal.
                </p>
            </div>

            <!-- contributor container -->
            <div class="grid grid-cols-4 gap-x-6 mx-auto max-w-6xl w-full sm:gap-y-6">
                
                <!-- contributor 1  -->
    
                <div class="col-span-1 max-w-sm bg-white p-4 rounded-2xl mx-auto text-center ring-2 ring-inset ring-prim/10 sm:col-span-4 sm:p-6">
                    <img class="pointer-events-none rounded-lg" src="{{ asset('img/kontributor1.jpg') }}" alt="">
                    <h3 class="text-sm font-semibold text-prim py-2 mt-2">Dirham</h3>
                    <button data-modal-target="default-modal-1" data-modal-toggle="default-modal-1" type="button" class="text-xs text-white bg-prim py-1.5 px-4 rounded-md font-semibold">
                        Lihat Profil
                    </button>
                </div>
                ...
                <div class="col-span-1 max-w-sm bg-white p-4 rounded-2xl mx-auto text-center ring-2 ring-inset ring-prim/10 sm:col-span-4 sm:p-6">
                    <img class="pointer-events-none rounded-lg" src="{{ asset('img/kontributor1.jpg') }}" alt="">
                    <h3 class="text-sm font-semibold text-prim py-2 mt-2">Asep</h3>
                    <button data-modal-target="default-modal-2" data-modal-toggle="default-modal-2" type="button" class="text-xs text-white bg-prim py-1.5 px-4 rounded-md font-semibold">
                        Lihat Profil
                    </button>
                </div>
                ...
                <div class="col-span-1 max-w-sm bg-white p-4 rounded-2xl mx-auto text-center ring-2 ring-inset ring-prim/10 sm:col-span-4 sm:p-6">
                    <img class="pointer-events-none rounded-lg" src="{{ asset('img/kontributor1.jpg') }}" alt="">
                    <h3 class="text-sm font-semibold text-prim py-2 mt-2">Rudi</h3>
                    <button data-modal-target="default-modal-3" data-modal-toggle="default-modal-3" type="button" class="text-xs text-white bg-prim py-1.5 px-4 rounded-md font-semibold">
                        Lihat Profil
                    </button>
                </div>
                ...
                <div class="col-span-1 max-w-sm bg-white p-4 rounded-2xl mx-auto text-center ring-2 ring-inset ring-prim/10 sm:col-span-4 sm:p-6">
                    <img class="pointer-events-none rounded-lg" src="{{ asset('img/kontributor1.jpg') }}" alt="">
                    <h3 class="text-sm font-semibold text-prim py-2 mt-2">Joko</h3>
                    <button data-modal-target="default-modal-4" data-modal-toggle="default-modal-4" type="button" class="text-xs text-white bg-prim py-1.5 px-4 rounded-md font-semibold">
                        Lihat Profil
                    </button>
                </div>
                ...
                <div class="relative p-4 w-full max-w-xl max-h-full sm:max-w-sm">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 class="text-xl font-semibold text-prim dark:text-white">
                                Contributors
                            </h3>
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-prim rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal-1">
                        ...
                        <div class="flex p-6 justify-between gap-x-4 sm:flex-col">
                        
                            <div class="flex flex-row w-fit sm:flex-col sm:mx-auto">
                            <img class="pointer-events-none w-56 p-4 bg-blue-100 rounded-xl sm:mb-2 sm:w-52" src="../assets/dirham.jpg" alt="">
                            </div>                                                                        

                            <div class="flex flex-col text-left w-full max-w-xs">
                            <h2 class="text-2xl font-bold text-gray-500 mb-1 sm:text-center">Dirhamsyah</h2>
                            <span class="inline-flex items-center rounded-md bg-prim bg-opacity-10 px-2 py-1 text-xs font-medium text-prim ring-1 ring-inset ring-prim/10 w-fit sm:mx-auto mb-2">Fullstack Developer</span>                                                   
                            <div class="mt-2 mb-2">
                                <p class="text-sm text-gray-500">Teknik Informatika</p>                          
                                <p class="text-sm text-gray-500">Universitas Dian Nuswantoro Semarang</p>                            
                                <p class="text-sm text-gray-500">blank@gmail.com</p>                            
                            </div>                                                                               
                            </div> 
                        </div>
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 justify-end">
                            <button data-modal-hide="default-modal-1" type="button" class="text-white bg-prim hover:bg-gratwo transition-all ease-in-out duration-300 font-semibold rounded-lg text-sm px-5 py-2 text-center">Tutup</button>                        
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full sm:max-w-sm">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-prim rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal-2">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <div class="flex p-6 justify-between gap-x-4 sm:flex-col">
                        ...
                        <div class="flex flex-row w-fit sm:flex-col sm:mx-auto">
                            <img class="pointer-events-none w-56 p-4 bg-blue-100 rounded-xl mb-1 sm:text-center sm:w-52" src="../assets/aldi.jpg" alt="">
                        </div>                                                                        

                        <div class="flex flex-col text-left w-full max-w-xs">
                            <h2 class="text-2xl font-bold text-gray-500 sm:text-center sm:mb-1">M Aldi Amanatullah S</h2>
                            <span class="inline-flex items-center rounded-md bg-prim bg-opacity-10 px-2 py-1 text-xs font-medium text-prim ring-1 ring-inset ring-prim/10 w-fit sm:mx-auto mb-2">Front-End Developer</span>                                                   
                            <div class="mt-2 mb-2">
                            <p class="text-sm text-gray-500">Teknik Informatika</p>                          
                            <p class="text-sm text-gray-500">Universitas Muhammadiyah Pekajangan Pekalongan</p>                            
                            <p class="text-sm text-gray-500">blank@gmail.com</p>                          
                            </div>                                                                               
                        </div> 
                    </div>
                    ...
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 justify-end">
                        <button data-modal-hide="default-modal-2" type="button" class="text-white bg-prim hover:bg-gratwo transition-all ease-in-out duration-300 font-semibold rounded-lg text-sm px-5 py-2 text-center">Tutup</button>                        
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full sm:max-w-sm">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-prim rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal-3">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <div class="flex p-6 justify-between gap-x-4 sm:flex-col">
                        ...
                        <div class="flex flex-row w-fit sm:flex-col sm:mx-auto">
                            <img class="pointer-events-none w-56 p-4 bg-blue-100 rounded-xl mb-1 sm:text-center sm:w-52" src="../assets/amin.jpg" alt="">
                        </div>                                                                        

                        <div class="flex flex-col text-left w-full max-w-xs">
                            <h2 class="text-2xl font-bold text-gray-500 sm:text-center sm:mb-1">M Khafid Al-Amien</h2>
                            <span class="inline-flex items-center rounded-md bg-prim bg-opacity-10 px-2 py-1 text-xs font-medium text-prim ring-1 ring-inset ring-prim/10 w-fit sm:mx-auto mb-2">Front-End Developer</span>                                                   
                            <div class="mt-2 mb-2">
                            <p class="text-sm text-gray-500">Teknik Informatika</p>                          
                            <p class="text-sm text-gray-500">Universitas Muhammadiyah Pekajangan Pekalongan</p>                            
                    ...
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 justify-end">
                        <button data-modal-hide="default-modal-3" type="button" class="text-white bg-prim hover:bg-gratwo transition-all ease-in-out duration-300 font-semibold rounded-lg text-sm px-5 py-2 text-center">Tutup</button>                        
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full sm:max-w-sm">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-prim rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal-4">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <div class="flex p-6 justify-between gap-x-4 sm:flex-col">
                        ...
                        <div class="flex flex-row w-fit sm:flex-col sm:mx-auto">
                            <img class="pointer-events-none w-56 p-4 bg-blue-100 rounded-xl mb-1 sm:text-center sm:w-52" src="../assets/yudan.jpg" alt="">
                        </div>                                                                        

                        <div class="flex flex-col text-left w-full max-w-xs">
                            <h2 class="text-2xl font-bold text-gray-500 sm:text-center sm:mb-1">Azfi Yudan</h2>
                            <span class="inline-flex items-center rounded-md bg-prim bg-opacity-10 px-2 py-1 text-xs font-medium text-prim ring-1 ring-inset ring-prim/10 w-fit sm:mx-auto mb-2">Ghrapic Designer</span>                                                   
                            <div class="mt-2 mb-2">
                            <p class="text-sm text-gray-500">Desain Komunikasi Visual</p>                          
                            <p class="text-sm text-gray-500">Telkom University Purwokerto</p>                            
                            <p class="text-sm text-gray-500">blank@gmail.com</p>                          
                            </div>                                                                               
                        </div> 
                    </div>
                    ...
                    <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 justify-end">
                        <button data-modal-hide="default-modal-4" type="button" class="text-white bg-prim hover:bg-gratwo transition-all ease-in-out duration-300 font-semibold rounded-lg text-sm px-5 py-2 text-center">Tutup</button>                        
                    </div>
                </div>
            </div>
            </div>
